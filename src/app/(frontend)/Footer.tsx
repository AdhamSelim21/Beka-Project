          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 text-sm text-white/80">
                ...
                <Link href="https://wa.me/201555239841" className="flex items-center justify-center md:justify-start gap-3 hover:text-green-400 transition-colors cursor-pointer">
                  <FaWhatsapp size={18} className="text-blue-400" />
                  <span>+20 1555239841</span>
                </Link>
                <Link href="https://wa.me/201555239851" className="flex items-center justify-center md:justify-start gap-3 hover:text-green-400 transition-colors cursor-pointer">
                  <FaWhatsapp size={18} className="text-blue-400" />
