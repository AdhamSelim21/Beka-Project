...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "services_sections_gallery" (
  	"_order" integer NOT NULL,
  ...
  ALTER TABLE "services_sections_gallery" ADD CONSTRAINT "services_sections_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."services_sections"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "services_sections_gallery_order_idx" ON "services_sections_gallery" USING btree ("_order");
  CREATE INDEX "services_sections_gallery_parent_id_idx" ON "services_sections_gallery" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "services_sections_gallery" CASCADE;
